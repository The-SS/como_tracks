...
def oval_track(L, R, ds=0.01, verbose=True, show=True, save=True, save_path=None, filename='track.csv'):
    """
    ...
    if save:
        ...
        with open(file, 'wb') as f:
            ...
            coord_writer.writerow(['edge1_x', 'edge1_y', 'centerline1_x', 'centerline1_y', 'edge2_x', 'edge2_y', 'cumulative_distance'])
            for row in zip_longest(*coord_rows):
                coord_writer.writerow(row)

if __name__ == "__main__":
    # Define the oval track
    oval_track(L=4., R=2., ds=0.01, verbose=True, show=False,
               save=True, save_path='tracks', filename='otsl_track.csv')
