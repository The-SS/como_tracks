...
class TrackPlotter:
    def __init__(self, lab_x, lab_y, rc_x, rc_y, csv_file):
        """
        Initializes the TrackPlotter class.
...
if __name__ == "__main__":
    ...
    road_animation = TrackPlotter(lab_x, lab_y, rc_x, rc_y, 'tracks/figure8_two_centerline_track.csv')
    ...
    road_animation.save_track('tracks', 'rotated_figure8_two_centerline_track.csv')
